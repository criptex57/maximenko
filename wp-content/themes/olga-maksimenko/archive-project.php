...
<section class="archive-grid section">
	...
	<article class="project-card"><a href="<?php echo esc_url( olga_url( get_permalink() ) ); ?>"><div class="project-card__image"><?php the_post_thumbnail( 'olga-project', array( 'alt' => olga_t( 'project_image_alt', olga_post_value( get_the_ID(), 'title' ) ) ) ); ?><span class="project-card__open"><?php echo esc_html( olga_t( 'open' ) ); ?> ↗</span></div><div class="project-card__info"><h2><?php echo esc_html( olga_post_value( get_the_ID(), 'title' ) ); ?></h2><span><?php echo esc_html( implode( ' · ', olga_project_meta() ) ); ?></span></div></a></article>
