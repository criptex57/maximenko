...
function olga_translations() {
	return array(
		...
		'name_placeholder' => array( 'ru' => 'Введите ваше имя', 'uk' => 'Введіть ваше ім’я', 'en' => 'Enter your name' ),
		'contact_method' => array( 'ru' => 'Телефон или мессенджер', 'uk' => 'Телефон або месенджер', 'en' => 'Phone or messenger' ),
		'contact_placeholder' => array( 'ru' => 'Введите контакт', 'uk' => 'Введіть контакт', 'en' => 'Enter your contact details' ),
		'email_placeholder' => array( 'ru' => 'Введите ваш email', 'uk' => 'Введіть ваш email', 'en' => 'Enter your email' ),
		'object_type' => array( 'ru' => 'Тип объекта', 'uk' => 'Тип об’єкта', 'en' => 'Property type' ),
		'object_placeholder' => array( 'ru' => 'Выберите тип объекта', 'uk' => 'Оберіть тип об’єкта', 'en' => 'Select property type' ),
		...
		'city_placeholder' => array( 'ru' => 'Введите город', 'uk' => 'Введіть місто', 'en' => 'Enter the city' ),
		'budget' => array( 'ru' => 'Ориентировочный бюджет', 'uk' => 'Орієнтовний бюджет', 'en' => 'Estimated budget' ),
		'budget_placeholder' => array( 'ru' => 'Укажите бюджет', 'uk' => 'Вкажіть бюджет', 'en' => 'Enter your budget' ),
		'message' => array( 'ru' => 'Сообщение', 'uk' => 'Повідомлення', 'en' => 'Message' ),
		'message_placeholder' => array( 'ru' => 'Введите сообщение', 'uk' => 'Введіть повідомлення', 'en' => 'Enter your message' ),
		...
		'form_success_title' => array( 'ru' => 'Заявка отправлена', 'uk' => 'Заявку надіслано', 'en' => 'Enquiry sent' ),
		'form_success' => array( 'ru' => 'Спасибо! Мы свяжемся с вами в ближайшее время.', 'uk' => 'Дякуємо! Ми зв’яжемося з вами найближчим часом.', 'en' => 'Thank you! We’ll be in touch shortly.' ),
